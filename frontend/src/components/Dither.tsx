...
function DitheredWaves({
  ...
  // Use useMemo so the uniforms object is stable and not accessed via ref during render
  ...
  // Listen on window so mouse interaction works even when hovering over content divs
  useEffect(() => {
